    ...
    <div style={styles.pageWrapper}>
      ...
      <main style={styles.contentWrapper}>
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={styles.p}>
            Welcome to AskBITSians. These Terms of Service ("Terms") govern your
            access to and use of our website, applications, and services
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          <h2 style={styles.h2}>2. Access and Account Registration</h2>
          <p style={styles.p}>
            Our Service allows you to sign in using Google authentication. By
        ...
        <section style={{ marginBottom: '2.5rem' }}>
          ...
          <p style={styles.p}>
            ...
            provide to us when you use our Service. You understand that through
            your use of the Service, you consent to the collection and use of
            this information as set forth in our Privacy Policy.
          </p>
        </section>
